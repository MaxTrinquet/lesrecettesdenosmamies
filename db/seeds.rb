...
auvert = Famille.new(name: "Auvert") # tu peux faire un .create directement
trinquet = Famille.new(name: "Trinquet")
auvert.save
trinquet.save # quand on utilise .save, ou .update, il vaut mieux utiliser leur version ! (.save! ou .update!) comme ca si y'a un pb, ca pete une erreur
...
tarte_aux_poires.famille = auvert # ==> Apres avoir ajouter des validations, tu verras que ce n'est pas correcte par rapport a ta db
# aussi, il vaut mieux mettre directement l'attribue family_id: auvert.id dans le .new (qui va devenir un .create)

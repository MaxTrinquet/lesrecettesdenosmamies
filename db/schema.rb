...
ActiveRecord::Schema.define(version: 2020_04_13_064426) do
  ...
  create_table "familles_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["famille_id"], name: "index_familles_users_on_famille_id"
    t.index ["user_id"], name: "index_familles_users_on_user_id"
  end
